...
function PaymentModal({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        title={`Abonar a la Cuenta de ${customer.name}`}
        description={`Deuda pendiente actual: ${money(customer.current_balance)}`}
      >
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        <div className="space-y-4">
          <div className="flex items-center justify-between p-3.5 rounded-xl border border-border/80 bg-secondary/30 text-xs">
            <div>
